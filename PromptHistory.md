...
This is a history log of all prompts that were successful when improving the quality of this project:

# 1. Removal of excessive maven plugin usage
```text
...
```
# 2. Removal of excessive maven-surefire-plugin and maven-failsafe-plugin (straight after the last one)
