...
class PlanetRepositoryHSQLKotlinTest @Autowired constructor(
    private val dataSource: DataSource
) {
    @Test
    @Throws(SQLException::class)
    fun testDataSourceOriginWhenQueryThenHSQL() {
        val shortConnectionString = dataSource.connection.toString()
        ConsolerizerComposer.outSpace()
            .magenta(shortConnectionString)
        shortConnectionString.shouldContain("org.hsqldb.jdbc.JDBCConnection")
    }
}